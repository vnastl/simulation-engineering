...
This is a **prototype** for **raw survey data + a codebook → a persona.

**Overview.** Open [`outputs/trace/trace.html`](outputs/trace/trace.html) for a walk-through of the current status.
